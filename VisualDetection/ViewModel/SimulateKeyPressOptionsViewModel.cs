...
{
    public class SimulateKeyPressOptionsViewModel : ViewModelBase, IOutputOption
    {
        #region Constructor
        public SimulateKeyPressOptionsViewModel()
        {
            SetDefaultValues();
        }
        #endregion
        ...
        {
            OptionTitle = GenDefString.SimulateKeyPressTitle;
        }
        #endregion
